...
let presets = ["HAHAHAHA ", "Oh, my goodnesss ", "But I still don't get it ", "I literally can't rn xD ", "LOL XD ", "That's pretty funny, 5/7", "DID YOU JUST", "OMG IM SCREAMING", "bruh", "same", "But is that the whole story?", "4/20 blaze it ", "IM DEAD", "Laughs in laughing", "Wow really? No way.", "Sure, whatever you say", "Why are we friends again?", "That's a yikes from me bro", "I'm stealing this post", "Still a better love story than Twilight", "This guy gets it", "uwu", "owo", "I'm telling", "I like that, and I respect that", "Hmmmmm", "i cri evertim", "nice", "Haha get it cuz the chicken doesn't have any hands"];
let pAttack = ["Yo @", "@", "Hey @", "Wow @"];
let pResponse = [" I didn't think you were this kind of person.", " did you really just say that?", " I totally agree", " needs a life", " reported.", " did you even consider my feelings!?"];

let randWords = ["which reminds me of this one time, ", "I walked down a long cobblestone road, ", "and that's when I met " + generateName() + ", ", generateName() + " and I decided that it was too late ", "it was all in good fun of course. ", "I looked up at the burning orange sky, ", "we went fishing for hours, it was a good time, ",  generateName() + " thought it was a good idea to keep going, ", "so we drove across the country, taking few stops, ", "I pressed on, believing that if I kept going, I would be rewarded, ", "the coffee shop around the corner was quaint and served delicious pastries, ", "but of course I couldn't stay forever, so I didn't worry too much about it. ", "I grilled so many burgers and hot dogs that even I lost count, ", "we stopped by the homeless person who told us the secret to life was hidden in the color \"pink\", ", "of course, I found it quite silly, ", "I could feel the wind gently caress my body, ", "my hands were still a little sticky from the pastry I had earlier ", "I liked that me and " + generateName() + " wore matching clothing. ", "that night I would see the most beautiful night sky, you should've been there, " , "the flowers blossomed quite nicely, I especially liked the red ones, ", "I remembered a story from a couple years ago, ", "maybe there's a moral to my story, that's for you to figure out. "];
